...
`DualPlaySampleScene`은 Unity Netcode for GameObjects와 Unity Transport를 사용해 두 실행 인스턴스가 Host와 Client로 접속하는 최소 2인 네트워크 예제다.
...
1. Unity에서 `Assets/Scenes/DualPlaySampleScene.unity`을 연다.
